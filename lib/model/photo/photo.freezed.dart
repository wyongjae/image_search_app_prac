...
abstract class $PhotoCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String previewURL});
}
...
class _$_Photo implements _Photo {
  _$_Photo({required this.id, required this.previewURL});
  ...
  @override
  String toString() {
    return 'Photo(id: $id, previewURL: $previewURL)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, previewURL);
...
abstract class _Photo implements Photo {
  factory _Photo({required final int id, required final String previewURL}) =
      _$_Photo;
